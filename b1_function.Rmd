...
basic_stats <- function(data, x, by, na.rm = TRUE) {
  # Check if dependencies are installed/loaded
  if (!requireNamespace("dplyr", quietly = TRUE)) {
    stop("The 'dplyr' package is required. Please install it to proceed.")
  } else if (!"dplyr" %in% loadedNamespaces()) {
...
Much better. _And there you have `basic_stats()`!_
